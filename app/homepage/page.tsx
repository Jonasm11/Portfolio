...
export default function ComprehensivePortfolio() {
  ...
  <a
    href="/"
    className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition-colors duration-300 shadow-lg"
  >
    <svg
    ...
    Zurück
            ...
            <main className="container mx-auto px-4 py-20">
                ...
                >
                    ...
                    <a
                        href="https://github.com/Jonasm11/Portfolio"
                        target="_blank"
